        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-8 flex flex-col justify-start">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <a
                href="/projects"
                className="inline-flex items-center justify-center gap-2 px-5 py-2 bg-[#FFFFFF] text-[#141414] font-medium rounded hover:bg-[#FAFAFA] transition-colors text-sm transition-all duration-200 ease-out
                hover:-translate-y-1 hover:shadow-lg hover:bg-trasparent
              ...
              <a
                href=""
                className="inline-flex items-center justify-center gap-2 px-5 py-2 border border-[#262626] text-[#FAFAFA] font-medium rounded hover:bg-[#1A1A1A] transition-colors text-sm transition-all duration-200 ease-out
                hover:-translate-y-1 hover:shadow-lg hover:bg-transparent
                active:translate-y-0.5"
              >
                Latest Posts
                <ArrowRight size={16} />
          ...
          <div className="space-y-4">
            ...
            <article className="p-6 bg-[#1A1A1A] border border-[#262626] rounded-lg hover:border-gray-500 transition-all group">
              <div className="space-y-3">
                ...
                <a
                  href="#article-1"
                  className="inline-flex items-center gap-2 text-[#A3A3A3]  hover:gap-3 transition-all"
                >
                  Read article
                  <ArrowRight size={16} />
                </a>
